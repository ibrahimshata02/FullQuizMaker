                                            ...
                                            ?>
                                                <tr data-count=<?php echo count($polls); ?> class="gray-row" id="survey_data" data-card-id=<?php echo $poll->poll_id; ?>>
                                                    ...
                                                    <td class="status-menu align-middle text-center">
                                                        <span id="statusDropDownMenu" class="badge badge-sm dropdown-toggle cursor-pointer status" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Active</span>

                                                        <div class="dropdown-menu shadow-sm border" aria-labelledby="statusDropDownMenu">
                                                            <button class="dropdown-item text-success" type="button" data-status="Active">Activate</button>
                                                            <button class="dropdown-item text-danger" type="button" data-status="Inactive">Deactivate</button>
                                                        </div>
                                                    </td>
