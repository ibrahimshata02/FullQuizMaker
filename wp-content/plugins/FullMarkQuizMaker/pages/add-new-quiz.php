    ...
    <main
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div id="cardsContainer" class="w-100 d-flex flex-column gap-3">
                <div class="quiz-card position-relative d-flex w-100 flex-column border colored-border-div-left w-100 p-4 border-top bg-white mb-2 rounded-3"
                    data-quiz-type="1">
                    <div style="width:25px; height: 25px; font-size: 13px;"
                        class="counter position-absolute d-flex justify-content-center align-items-center top-0 start-0 bg-primary text-white rounded-full p-3">
                    </div>
                    <div class="d-flex align-items-center gap-4 mb-2 mt-2">
                        ...
                        <div class="d-flex align-items-center gap-3 w-50">
                            <select id="quizTypeSelect" class="w-100 border bg-transparent p-2 "
                    ...
                    <div class="d-flex justify-content-end gap-4 p-2">
                        <i title="Add new question card"
                            class="fa-solid fa-circle-plus fa-lg text-dark cursor-pointer"></i>
                        <i title="Duplicate question card"
                            class="fa-regular fa-copy fa-lg text-dark cursor-pointer"></i>
