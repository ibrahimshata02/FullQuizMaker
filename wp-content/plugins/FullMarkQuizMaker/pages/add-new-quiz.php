                    ...
                    <div class="d-flex align-items-center gap-4 mb-2 mt-4">
                        ...
                        <div class="d-flex align-items-center gap-3 w-50">
                            ...
                            <label for="image_upload" class="upload-icon file-input-label cursor-pointer m-0">
                                ...
                                <input class="image_upload_input m-0" type="file" id="image_upload">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between p-2">
                        <div class="difficulty-container d-flex flex-column gap-1">
                            ...
                            <div class="d-flex flex-row align-items-center gap-2 ">
                                <input type="range" class="form-range" value="1" min="1" max="5" step="1" id="difficulty">
                                <p id="range_text" class="m-0 fw-bolder" style="font-size: 15px;">1/5</p>
                            </div>
                        </div>
        ...
        jQuery(document).ready(function(jQuery) {
                ...
                function updateQuizzes() {
                    ...
                    quiz_cards.forEach((card, index) => {
                        ...
                        // Upload function
                        const image_upload_input = card.querySelector('.image_upload_input');
                        const image_container = card.querySelector('.image_container');

                        image_upload_input.addEventListener("change", (event) => {
        ...
        document.addEventListener("click", function(event) {
            if (event.target.classList.contains("fa-circle-plus")) {
                ...
                newCard.innerHTML = `<div class="quiz-card position-relative d-flex w-100 flex-column border colored-border-div-left w-100 p-4 border-top bg-white mb-2 rounded-3" data-quiz-type="1">
                    ...
                    <div id="addNewOptionContainer" class="d-flex align-items-center gap-3">
                        <input disabled type="radio">
                        <a id="add_new_option" class="cursor-pointer opacity-80 text-primary text-sm m-0" title="Add new option">Add new option</a>
                    </div>
