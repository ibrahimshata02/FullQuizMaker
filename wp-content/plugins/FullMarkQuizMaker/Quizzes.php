                                        ...
                                        <tr data-count=<?php echo count($polls); ?> class="gray-row" id="survey_data"
                                            ...
                                            <td class="text-center d-flex align-items-center justify-content-center px-0 py-4 gap-lg-3 gap-md-2 gap-1"
                                                ...
                                                <a
                                                    ...
                                                    <i class="fas fa-chart-bar text-sm text-dark"
                                                        style="cursor: pointer"></i>
                                                </a>
                                                <a
                                                    href="<?php echo admin_url('admin.php?page=poll-survey-xpress-surveys&template=' . $poll->template . '&poll_id=' . $poll->poll_id . '&action=edit'); ?>">
                                                    <i class="fas fa-gear text-sm text-dark"
                                                        style="cursor: pointer"></i>
                                                </a>

                                                <i style="cursor: pointer"
                                                    class="fas fa-trash text-sm text-danger archiveButton"
                                                    data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                    data-poll-id="<?php echo $poll->poll_id; ?>"></i>
